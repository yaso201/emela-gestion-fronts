...
export { getPendingValidations, decideAcompte, decideNoteDeFrais, decideHeuresSup, decideConge, decideAttestation, provisionUser, updatePayrollParameter, previewSeparation, generateDeclaration, getOnboardingRequests, createOnboardingRequest, decideOnboardingRequest, createEmployeeFromRequest, getAccessAudit, getAccessReview, recordAccessReview, getFacturesExternes, decideFacture, transmettreFacture, getBeneficiaires, saveBeneficiaire, setBeneficiaireStatut, getRetirementStatus, getCareerStatement, getDeliveredAttestations, getRetirementCohort, getComposantes, getHrLetters, getHrLetterTemplates, createHrLetter, transitionHrLetter } from '../client/frappe';
export type { DecisionResult, PendingValidations, PendingRow, OnboardingContext, OnboardingRequest, AccessEvent, AccessHolder, AccessReviewContext, FactureExterne, FactureDecision, FactureTransmission, BeneficiaireExterne, BeneficiaireInput, RetirementStatus, CareerStatement, CareerLine, AttestationRow, RetirementCohort, HrLetter, HrLetterTemplate } from '../client/frappe';
