...
export { getPendingValidations, decideAcompte, decideNoteDeFrais, decideHeuresSup, decideConge, decideAttestation, provisionUser, updatePayrollParameter, previewSeparation, generateDeclaration, getOnboardingRequests, createOnboardingRequest, decideOnboardingRequest, createEmployeeFromRequest, getAccessAudit, getAccessReview, recordAccessReview, getFacturesExternes, decideFacture, transmettreFacture, getBeneficiaires, saveBeneficiaire, setBeneficiaireStatut, getRetirementStatus, getCareerStatement, getDeliveredAttestations } from '../client/frappe';
export type { DecisionResult, PendingValidations, PendingRow, OnboardingContext, OnboardingRequest, AccessEvent, AccessHolder, AccessReviewContext, FactureExterne, FactureDecision, FactureTransmission, BeneficiaireExterne, BeneficiaireInput, RetirementStatus, CareerStatement, CareerLine, AttestationRow } from '../client/frappe';
